...
import com.dicoding.capstone.skindect.viewmodel.ResultViewModel
import com.dicoding.capstone.skindect.viewmodel.ViewModelFactory
import com.dicoding.capstone.skindect.databinding.ActivityResultBinding
...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setRecommendationList(diagnosis)
    ...
    private fun setRecommendationList(diagnosis: String?) {
        if (diagnosis.isNullOrEmpty()) {
            binding.tvRecommendation.text = getString(R.string.no_recommendation)
        } else {
            binding.tvRecommendation.text = getDiseaseRecommendation(diagnosis)
        }
    }
