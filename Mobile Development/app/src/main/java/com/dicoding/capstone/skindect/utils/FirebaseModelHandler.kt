package com.dicoding.capstone.skindect.utils
...
class FirebaseModelHandler(private val context: Context) {
    ...
    private fun loadLocalModel() {
        val localModelFile = File(context.filesDir, "modelv2-6.tflite")
    ...
    fun downloadModel(
        ...
        FirebaseModelDownloader.getInstance()
            .getModel("Skin_Detection", DownloadType.LOCAL_MODEL, conditions)
