...
import com.dicoding.capstone.skindect.databinding.ActivityScanBinding
import com.dicoding.capstone.skindect.repository.ScanRepository
import com.dicoding.capstone.skindect.viewmodel.ScanViewModel
...
class ScanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scanViewModel.analysisResult.observe(this) { result ->
            ...
            val recommendation = getDiseaseRecommendation(diagnosis)
